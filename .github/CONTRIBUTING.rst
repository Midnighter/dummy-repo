...
Report bugs at https://github.com/Midnighter/dummy-repo/issues.
...
dummy-repo could always use more documentation, whether as part of the
...
https://github.com/Midnighter/dummy-repo/issues.
...
Ready to contribute? Here's how to set up dummy-repo for
local development.

1. Fork the https://github.com/Midnighter/dummy-repo
   repository on GitHub.
2. Clone your fork locally

   .. code-block:: console
   
       git clone git@github.com:your_name_here/dummy-repo.git
